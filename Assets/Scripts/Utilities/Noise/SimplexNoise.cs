// // --------------------------------------------------------------------------------------------------------------------
// // <copyright file="SimplexNoise.cs" author="Lars-Kristian Svenoey">
// // All rights reserved.
// // </copyright>
// // <summary>
...
namespace Core.Generation.Noise
{
    using System;
    ...
    public class SimplexNoise
    {
        private static readonly byte[] permOriginal =
            {
                ...
                128, 195, 78, 66, 215, 61, 156, 180, 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7,
        ...
        public static float[] Calc1D(int width, float scale)
        {
            ...
            for (var i = 0; i < width; i++) values[i] = Generate(i * scale) * 128 + 128;
            return values;
        }
        ...
        public static float[,] Calc2D(int width, int height, float scale)
        {
            ...
            for (var j = 0; j < height; j++) values[i, j] = Generate(i * scale, j * scale) * 128 + 128;
            return values;
        }
        ...
        public static float[,,] Calc3D(int width, int height, int length, float scale)
        {
            ...
            for (var k = 0; k < length; k++) values[i, j, k] = Generate(i * scale, j * scale, k * scale) * 128 + 128;
            return values;
        }
